            ...
            {cenarios.length > 1 && (
              <button
                ...
                onClick={() => {
                  ...
                  if (
                    confirm(
                      `Excluir o organograma "${cenarioAtivo.nome}" (${cenarioAtivo.dados?.pessoas?.length || 0} cargos)?` +
                        `\n\nUma cópia de segurança é guardada e pode ser recuperada na faixa que aparece no topo.`,
                    )
                  ) {
